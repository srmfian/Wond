...
class Store:
    ...
    def init(self) -> None:
        ...
        self.ensure_column("speakers", "confidence", "REAL")
        self.ensure_column("speaker_match_decisions", "source_display_name", "TEXT")
        self.ensure_column("speaker_match_decisions", "target_display_name", "TEXT")
        self.conn.commit()
